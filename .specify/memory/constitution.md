...
Modified principles:
- Placeholder Principle 1 -> I. Clean Code Is Required
- Placeholder Principle 2 -> II. Responsive UX By Default
- Placeholder Principle 3 -> III. Responsive Design Standards
- Placeholder Principle 4 -> IV. Framework Alignment: Next.js + React
- Placeholder Principle 5 -> V. Minimal Dependencies
Added sections:
...
- backend/README.md: reviewed, no change required
- docs/ROADMAP.md: updated
Follow-up TODOs:
- TODO(PACKAGE_ALIGNMENT): frontend/package.json currently declares Vite + React, not
  Next.js + React. Migrate the frontend package before implementing new UI work.
-->
